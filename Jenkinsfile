    ...
    stages {
        stage('Checkout Git Repository') {
            steps {
                ...
                git branch: 'master', url: 'https://github.com/gangak19/Medicure-healthcare.git'
            }
        }
        ...
        stage('Build Docker Image') {
            steps {
                ...
                sh 'docker build -t gangak/healthcareapp:1.0 .'
            }
        }
        ...
        stage('Push Docker Image') {
            steps {
                ...
                sh 'docker push gangak/healthcareapp:1.0'
            }
        }
